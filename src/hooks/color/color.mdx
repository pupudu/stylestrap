...
import { PropsTable, InfoCard, Preview, Spaced, Playground, Helpers } from '../../components/docs';
import { Box, Grid, Cell, Badge, Heading, Button, Link } from '../../';
import { ButtonColor, ButtonColorVariants } from './Presets';

# useColor
<Helpers.Subtitle>Use our color util hooks to get variants of theme colors.</Helpers.Subtitle>
